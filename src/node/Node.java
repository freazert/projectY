...
//	private List<FileFiche> FicheList;
    ...
    public void addLocalList(String fileName) {
        ...
        this.fileList.addLocalFileList(name);
    }
     ...
     * @throws JSONException Something went wrong while creating the JSON
     * object.
     */
     ...
     *
     * @throws InterruptedException there went something wrong in the send file
     * thread. the thread was stopped preemptively.
     */
     ...
     * node.
     * @throws IOException Something went wrong while writing to the UDP socket
     */
